...
urlpatterns = [
    ...
    path('jobs/<str:pk>/', login_required(views.JobDetailView.as_view()),
         name='job_detail'),
    path('jobs/update/<str:pk>/',
         login_required(views.JobUpdateView.as_view()), name='job_update'),
    path('jobs/delete/<str:pk>/',
         login_required(views.JobDeleteView.as_view()), name='job_delete'),
    ...
    path('skills/new/', login_required(views.SkillCreateView.as_view()),
         name='skill_new'),
    path('skills/<str:pk>/',
         login_required(views.SkillDetailView.as_view()), name='skill_detail'),
    path('skills/update/<str:pk>/',
         login_required(views.SkillUpdateView.as_view()), name='skill_update'),
    path('skills/delete/<str:pk>/',
         login_required(views.SkillDeleteView.as_view()), name='skill_delete'),
]
